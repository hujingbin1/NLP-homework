...
with jsonlines.open('..\\data_final_exp_10_29\\label_exp_train_10_29\\ICD_train.txt', 'w') as writer:
...
with jsonlines.open('..\\data_final_exp_10_29\\label_exp_train_10_29\\ICD_train_label.txt', 'w') as writer:
    writer.write_all(ainfo)



with open('..\\data_final_exp_10_29\\label_exp_train_10_29\\ICD_train_label.txt', 'r',encoding='utf-8') as file:
...
with open('..\\data_final_exp_10_29\\label_exp_train_10_29\\ICD_train_label.csv', 'w', newline='',encoding='utf-8') as file:
